...
class LedgerSecurityTest {
    ...
    void accessWithoutToken_ReturnsUnauthorized() {
        ResponseEntity<String> response = restTemplate.getForEntity("/api/v1/ledger-accounts/00000000-0000-0000-0000-000000000000", String.class);
    ...
    void accessWithTraderRole_GetRequest_ReturnsOk() {
        ...
        ResponseEntity<String> response = restTemplate.exchange("/api/v1/ledger-accounts/00000000-0000-0000-0000-000000000000", HttpMethod.GET, entity, String.class);
    ...
    void accessWithTraderRole_PostRequest_ReturnsOk() {
        ...
        ResponseEntity<String> response = restTemplate.exchange("/api/v1/journals", HttpMethod.POST, entity, String.class);
